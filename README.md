...
Crear el repositorio en GitLab (vacío y público).
Obtener la URL del remoto.
Añadirlo al repositorio local: git remote add gitlab
Verificar remotos configurados: git remote -v
Subir los archivos: git push gitlab main
Repetir para otras ramas si es necesario.
...
| * | a5cc4fe (origin/Rama1_5291, Rama1_5291) Añadir comentario en README.md para rama 1 de la etapa 7 | * | 744e6f7 Añadir comentario en README.md para rama 1 de la etapa 7 |/ / | * 2c6734d (origin/Rama2_5291, Rama2_5291) Añadir comentario en README.md para rama 2 de la etapa 7 | * f68e54b Añadir comentario en README.md para rama 2 de la etapa 7 |/
7ee9df5 Añadir un comentario al fichero al fichero server.js
0afc7ca Cambiar el color de fondo del botón
5569243 Primer commit: etapa 4


## Trabajo con múltiples remotos

Tener varios remotos significa que un mismo repositorio local puede sincronizarse
con más de un servidor o plataforma, como GitHub y GitLab.

### Ventajas
- Mayor disponibilidad y respaldo.
- Posibilidad de colaborar en distintas plataformas.
- Redundancia del proyecto.
- Permite flujos de integración distintos.

### Inconvenientes
- Mayor complejidad en la gestión de ramas.
- Riesgo de divergencia entre remotos si no se sincronizan correctamente.
- Más pasos manuales.
